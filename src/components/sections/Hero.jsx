      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          >
            ...
            <a
              href="/blog"
              className="flex items-center px-6 py-3 bg-accent-700 text-white backdrop-blur-sm rounded-lg overflow-hidden border border-primary-200 dark:border-primary-700 shadow-[0_4px_20px_rgba(14,165,233,0.15)] hover:shadow-[0_4px_25px_rgba(14,165,233,0.25)] transition-all duration-300 hover:bg-accent-800 "
            >
            ...
            {socialLinks.map((link, index) => (
              ...
              >
                <SocialLink
                  href={link.href}
                  icon={link.icon}
                  className="text-accent-600 hover:text-primary-600 dark:text-accent-300 backdrop-blur-sm rounded-lg overflow-hidden border border-primary-200 dark:border-primary-700 shadow-[0_4px_20px_rgba(14,165,233,0.15)] hover:shadow-[0_4px_25px_rgba(14,165,233,0.25)] transition-all duration-300 dark:hover:text-primary-400 "
